...
public class QsP {
	...
	public static int anzDurchlauf = 0;
	public static int anzVergleich = 0;
		...
		if(begin<end) {
			...
			while(true) {
				...
				if(begintemp < endtemp) {
					...
					array[endtemp] = hilf;
					/*System.out.println("Begintemp: " + begintemp);
	...
	public static void safe(){
		System.out.println("\nAnzahl Durchläufe: " + anzDurchlauf);
		System.out.println("Anzahl Vergleiche: " + anzVergleich + "\n");
	}
